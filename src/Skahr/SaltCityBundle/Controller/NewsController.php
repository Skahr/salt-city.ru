...
use Skahr\SaltCityBundle\Entity\News;
use Skahr\SaltCityBundle\Form\NewsType;
...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SkahrSaltCityBundle:News')->findAll();

        return $this->render('SkahrSaltCityBundle:News:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SkahrSaltCityBundle:News:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SkahrSaltCityBundle:News')->find($id);
        ...
        return $this->render('SkahrSaltCityBundle:News:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SkahrSaltCityBundle:News:edit.html.twig', array(
            'entity'      => $entity,
